            ...
            for (let j = 0; j < this.all_player_data.length; j++) {
                if (this.all_player_data[j].mesh.position.x > this.camera.position.x - this.screenWidth
                    ...
                    if (this.all_player_data[j].plane_type !== 3 && this.all_player_data[j].plane_type !== 4) {
                        ...
                        // else
                        if (test > 0.25) {
                            this.all_player_data[j].mesh.position.x = this.myLerp(this.all_player_data[j].mesh.position.x, this.all_player_data[j].final_positionx[0], 0.25 / test);
                        }
                        else {
                    ...
                    if (this.all_player_data[j].onplane === null) {
                        ...
                        let test = (this.all_player_data[j].mesh.position.y - this.all_player_data[j].final_positiony[0]);
                        ...
                        // else 
                        if (test > 0.15) {
                            this.all_player_data[j].mesh.position.y = this.myLerp(this.all_player_data[j].mesh.position.y, this.all_player_data[j].final_positiony[0], 0.15 / test);
                        }
                        else {
