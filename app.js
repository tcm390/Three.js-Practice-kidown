...
class App {
    ...
    loadPlayer(id, positionx, positiony, r, g, b, name) {
        ...
        this.all_player_data.push({ mesh: model, id: id, onplane: null, plane_type: 0, onplane_time: 0, last_moving_time: 0, name_mesh: text2, animation: 3, final_positionx: positionx, final_positiony: 20 });
    ...
    render() {
        ...
        for (let j = 0; j < this.all_player_data.length; j++) {
            if (this.all_player_data[j].plane_type !== 3 && this.all_player_data[j].plane_type !== 4) {
                ...
                else if (this.all_player_data[j].mesh.position.x - this.all_player_data[j].final_positionx >= 1) {
                ...
                else if (this.all_player_data[j].final_positionx - this.all_player_data[j].mesh.position.x >= 1) {
                    this.all_player_data[j].mesh.position.lerp(new THREE.Vector3(this.all_player_data[j].final_positionx, this.all_player_data[j].mesh.position.y, 0), 0.4 / test)
                }
