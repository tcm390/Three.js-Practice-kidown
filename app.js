            ...
            this.worker.onmessage = (e) => {
                ...
                if (e.data.type === 'assign_plane') {
                    ...
                    for (let j = 0; j < e.data.data.length; j++) {
                        ...
                        if (this.all_player_data[e.data.data[j].player].mesh.position.y - (this.all_player_data[e.data.data[j].player].onplane.position.y + 1) < 0
            ...
            for (let j = 0; j < this.all_player_data.length; j++) {
                if (this.all_player_data[j].mesh.position.x > this.camera.position.x - this.screenWidth
                    ...
                    if (this.all_player_data[j].onplane === null) {
                        ...
                        // if (Math.abs(this.all_player_data[j].final_positiony[1] - this.all_player_data[j].mesh.position.y) >= 4.5) {
                        //     //this.all_player_data[j].mesh.position.y -= 4.2;
